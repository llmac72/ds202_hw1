...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Lisa McDaniel** and my major (25+ years ago) was *Civil Engineering*.  I also have a masters in *Civil Engineering* with an emphasis in pavements and materials and a minor in *Statistics*.  I currently work for the Federal Highway Administration (in Ames) as the Division Pavements and Materials Engineer.  I am pursuing a Data Science certificate.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: My position as a Pavements and Materials Engineer incorporates many data science principles.  One of my resposibilites is to perform program reviews and process evaulations used by the Iowa Department of Transportation in construction.  Basing my reviews/evaulations on data can eliminate some of the subjectivity that can creep into these types of reviews.  The Iowa DOT collects a significant amount of pavememt and testing data so there is a lot of opportunity to incorporate data science principles into my reviews.
    
    https://www.fhwa.dot.gov/iadiv/
    
 
    <img src="http://clipart-library.com/img/245991.jpg" width="200" height="100" />

    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I would like to use the Iowa DOT's 5 year plan to see what is being programmed for constrution in the next 5 years, where the projects are being constructed across the state, how much the projects cost (it would be interesting to see if project costs vary across the state) how much of the project cost is federal, state, and/or local agency funding.
